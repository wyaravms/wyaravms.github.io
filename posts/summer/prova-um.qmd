...
Let $\mathbf{Q}$ the square of vertices (+1,0), (-1,0), (0,+1), (0,-1) and $(X,Y)$ the vector with joint density
\begin{equation*}
\begin{array}{lclll}
...
We have that the margins of $X$ and $Y$ are given by:
For $X$, we have:
